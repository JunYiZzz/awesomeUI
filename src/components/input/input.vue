<template>
    <div :class="wrapClasses">
        <template v-if="type !== 'textarea'">
            <!--
            @description slot方式插入input 的前置内容
            -->
            <div :class="[prefixCls + '-group-prepend']" v-if="prepend" v-show="slotReady"><slot name="prepend"></slot></div>
            <!--
            @description 清空按钮,用currentValue控制为空时不显示清空按钮
            -->
            ...
            <!--
            @description input尾部图标，属性方式设置，非清空情况下显示 
            -->
            <i class="ivu-icon" :class="['ivu-icon-' + icon, prefixCls + '-icon', prefixCls + '-icon-normal']" v-else-if="icon" @click="handleIconClick"></i>
            <!--
            @description 尾部查询图标，非enter-button，只有图标
            -->
            ...
            <input
                ...
                @change="handleChange">
                <!--
                @description slot方式插入input 的后置内容
                -->
            <div :class="[prefixCls + '-group-append']" v-if="append" v-show="slotReady"><slot name="append"></slot></div>
            <!--
            @description 尾部查询图标，enter-button,有确认按钮
            -->
